...
RAW_PRICES_DIR = RAW_STOCKS_DIR / "prices"
RAW_ADJUST_FACTORS_DIR = RAW_STOCKS_DIR / "adjust_factors"
...
for _dir in [
    STORAGE_DIR, RAW_STOCKS_DIR, RAW_PRICES_DIR, RAW_ADJUST_FACTORS_DIR,
    RAW_ZT_POOL_DIR, PROCESSED_RETURNS_DIR, DATABASE_DIR,
